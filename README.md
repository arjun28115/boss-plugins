...
| [run-ledger](run-ledger/) | Records what produced each result: the command, the commit, the uncommitted diff, and the output files, rescued out of scratch directories |
